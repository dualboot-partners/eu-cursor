# Best Practices Cursor Custom Agents and Rules Generator
...
- Short, focused rules (target: 25 lines, maximum: 200 lines)
...
git clone https://github.com/dualboot/eu-cursor.git
cd eu-cursor
...
### Software
- speech to text [https://wisprflow.ai/](https://wisprflow.ai/) | [https://superwhisper.com/](https://superwhisper.com/)
- prompts [https://repoprompt.com/](https://repoprompt.com/)

### MCP
- [Tavity](https://github.com/tavily-ai/tavily-mcp) - usefull for the web search
- [browsertools](https://browsertools.agentdesk.ai/installation) - access to browser console, selected element, logs
